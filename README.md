...
## نتایج
کلیه نتایج در مسیر [results](https://github.com/LordArma/cambrac/tree/master/results) ذخیره شده‌اند. نام هر پوشه شامل دو عدد است که عدد نخست بیانگر بیشترین اندازه ماتریس و عدد دوم میزان قدم است.
تصویر زیر خروجی سنگین‌ترین آزمایش صورت گرفته است که با ماتریسی به طول و عرض ۲۰ هزار و با قدم‌های هزار انجام شده است.
![alt text](https://github.com/LordArma/cambrac/blob/master/results/Until20000Step1000/plot.png?raw=true "نتیجه اجرا تا سقف ۲۰ هزار با گام هزار")
